...
## Plot
png("C:/aaaaaaaaaaaaa/coursera/Data science/4.Explotry data analysis/ExploryDataAnalysis_Project1/plot3.png", width = 480, height = 480)
...
lines(household_power_consumption$Time,
